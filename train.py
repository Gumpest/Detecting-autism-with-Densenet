...
# 加载数据集
dataset = ImageFolder('./input/autistic-children-data-set-traintestvalidate/consolidated', transform=ToTensor())
...
history = fit(num_epochs, lr, Net, train_dl, val_dl, opt_func)